                    ...
                    <div class="col-lg-6 col-12">
                        <form action="{{route('checkout.store', $camps->id)}}" class="basic-form" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input name="card_number" type="number" class="form-control {{$errors->has('card_number') ? 'is_invalid' : ''}}" value="{{old('card_number') ? : ''}}" required />
                            ...
                            <div class="mb-5">
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <input name="expired" type="month" class="form-control {{$errors->has('expired')}}" value="{{old('expired') ? : ''}}" required />
                                    ...
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <input name="cvc" type="number" class="form-control {{$errors->has('cvc')}}" maxlength="3" value="{{old('cvc') ? : ''}}" required />
                                        @if ($errors->has('cvc'))
